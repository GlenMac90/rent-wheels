...
const SearchPageFilters = () => {
  ...
  return (
    <>
      <form className="bg-white_gray-900 no-scrollbar sticky top-[5.75rem] z-20 flex w-full flex-col border-b border-r border-b-blue-50/40 border-r-white-100 p-6 shadow dark:border-b-gray-850 dark:border-r-gray-850 sm:top-[6.25rem] lg:max-w-[20rem] lg:overflow-scroll">
